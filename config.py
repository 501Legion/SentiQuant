...
WSB_NEUTRAL_RATIO_MAX = 0.75         # neutral/total 초과 시 NEUTRAL 강제 (0.70→0.75, FinBERT 보수성 완화 2026-06-08)
...
COMMUNITY_NEUTRAL_RATIO_MAX = 0.75   # (0.70→0.75, FinBERT 보수성 완화 2026-06-08)
...
# 정상 운영: 전일 16:30 ET 신호잡 수집 → 익일 09:35 ET 주문잡 사용(주말 포함 최대 ~4일).
