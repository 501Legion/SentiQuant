...
WSB_NEUTRAL_RATIO_MAX = 0.96         # PAPER LOOSE×OFF 2026-06-14 (orig 0.95) — 극단 노이즈 컷, 초과 시에만 NEUTRAL 강제
WSB_MIN_DIRECTIONAL_MENTIONS = 2     # PAPER LOOSE×OFF 2026-06-14 (orig 3) — bull+bear 합계 미만 → NEUTRAL 강제
...
WSB_OPINION_SCORE_LOW  = 52.0          # PAPER LOOSE×OFF 2026-06-14 (orig 57.0) — 미만 진입 제외 (COMMUNITY_OPINION_SCORE_LOW 파생)
...
COMMUNITY_CONSENSUS_MIN_RATIO = 1.3    # PAPER LOOSE×OFF 2026-06-14 (orig 1.5)
...
COMMUNITY_NEUTRAL_RATIO_MAX = 0.95     # PAPER LOOSE×OFF 2026-06-14 (orig 0.90)
...
COMMUNITY_OPINION_SCORE_LOW = WSB_OPINION_SCORE_LOW     # 미만 진입 제외
...
COMMUNITY_LLM_ROUTER_ENABLED = False   # PAPER LOOSE×OFF 2026-06-14 (orig True) — veto 제거, 순수 모멘텀 룰 페이퍼테스트
